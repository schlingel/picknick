...
class SlashedHrefTag extends HtmlHelperTag {
    ...
    public function  GetTag($parameter) {
        ...
        $kernelFile = (isset($parameter['kernel'])) ? $parameter['kernel'] : __DEFAULT_KERNEL_LOCATION__;
     ...
     * @return string
     */
    protected function GetHrefForPage($location, $parameter=array(), $kernelFile=__DEFAULT_KERNEL_LOCATION__) {
 ...
 */
class SlashedLinkHrefTag extends SlashedHrefTag {
    /**
